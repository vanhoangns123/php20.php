...
<body>
    <div class="container">
        ...
        <a href="categories_add_process.php" class="btn btn-primary">Add New Category</a>
        <table class="table">
            <thead>
                <th>ID</th>
                <th>Name</th>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="categories_edit.php?id=<?=$item['id']?>" class="btn btn-success">Edit</a>
                    <a href="categories_delete.php?id=<?=$item['id']?>" class="btn btn-danger">Delete</a>
                </td>
            </tr>
			<?php } ?>
